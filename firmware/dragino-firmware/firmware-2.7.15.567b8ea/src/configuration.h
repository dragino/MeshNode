...
#if !defined(DRAGINO_LINUX) && !defined(MESHTASTIC_MINIMIZE_BUILD)
...
// Dragino gateways use the private 286 TimeSyncModule instead of Meshtastic's
// public PositionModule/GPS path.
#if defined(DRAGINO_GATEWAY) && !defined(MESHTASTIC_EXCLUDE_GPS)
#define MESHTASTIC_EXCLUDE_GPS 1
#endif
...
// #define MESHTASTIC_EXCLUDE_TIMESYNC 1  // TimeSyncModule replaces PositionModule for time sync when GPS is excluded
#endif
