...
#endif
#if defined(MESHTASTIC_EXCLUDE_GPS) && !defined(MESHTASTIC_EXCLUDE_TIMESYNC) && defined(DRAGINO)
...
#include "dragino/DraginoConfigModule.h"
#include "dragino/DraginoModule.h"
#if defined(DRAGINO_OTA_LAB)
#include "dragino/DraginoOtaModule.h"
#endif
#if defined(DRAGINO_GATEWAY)
#include "dragino/DraginoBusinessBridge.h"
#endif
#if defined(DRAGINO_REMOTENODE) && defined(DRAGINO_STM32)
#include "dragino/DraginoHardware.h"
#include "dragino/DraginoSHT3xSensor.h"
#include "dragino/DraginoBluetooth.h"
#include "dragino/DraginoWakeupComm.h"
#endif
#endif
...
void setupModules()
{
    ...
    timeSyncModule = new TimeSyncModule();
#endif
#if !MESHTASTIC_EXCLUDE_WAYPOINT
...
#ifdef DRAGINO
    dragino::draginoConfigModule = new dragino::DraginoConfigModule();
    dragino::draginoModule = new dragino::DraginoModule();
#if defined(DRAGINO_OTA_LAB)
    dragino::draginoOtaModule = new dragino::DraginoOtaModule();
#endif
#if defined(DRAGINO_GATEWAY)
    dragino::draginoBusinessBridge = new dragino::DraginoBusinessBridge();
#endif
#if defined(DRAGINO_REMOTENODE) && defined(DRAGINO_STM32)
    dragino::draginoHardware = new dragino::DraginoHardware();
#if DRAGINO_SHT3X_ENABLE
    dragino::draginoSHT3xSensor = new dragino::DraginoSHT3xSensor();
#endif
    dragino::draginoWakeupComm = new dragino::DraginoWakeupComm();
    dragino::draginoBluetooth = new dragino::DraginoBluetooth();
